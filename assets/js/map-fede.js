...
function createWMSLayer(title, layerName) {
    ...
    const populationExposureGroup = new ol.layer.Group({  // <-- MODIFICATO (nuovo gruppo)
    ...
    // ==============================
    // GROUP: POLLUTANT CONCENTRATION
    // ==============================

    const pollutantGroup = new ol.layer.Group({           // <-- MODIFICATO (nuovo gruppo)
    ...
    const layerSwitcher = new LayerSwitcher({
        ...
        startActive: true,
        tipLabel: 'Layers',
        groupSelectStyle: 'children'  // mostra i checkbox per ogni layer nei gruppi
    });
